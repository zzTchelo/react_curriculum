...
const Contacts = () => {
    return (
        <ul className="contacts">
            ...
            <li className="contact"><img src={instagramIcon} alt="Icone_Instagram" />@silvasantosjoaomarcelo</li>
            <li className="contact"><img src={outlookIcon} alt="Icone_Outlook" />jmarcelo06@outlook.com</li>
            <li className="contact"><img src={youtubeIcon} alt="Icone_Youtube" />João Marcelo Silva Santos</li>
        </ul>
    )
}
